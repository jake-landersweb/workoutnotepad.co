	...
	items := []*PremiumCell{
		{
			...
			Src:   "/public/images/previews/reps-graph.png",
			Alt:   "Reps Graph",
		},
		{
			Title: "Workout Category Distribution",
			Desc:  "View powerful yet flexible graphs on all of the exercises you have logged. View your reps or weight distribution grouped by either set number or date it was logged. Gone are the days of excel charts and graphs, viewing your progress in an interactive way has never been easier.",
			Src:   "/public/images/previews/categories.png",
		...
		},
		{
			...
			Src:   "/public/images/previews/category.png",
			Alt:   "Category Page",
		},
		{
			...
			Src:   "/public/images/previews/image.png",
			Alt:   "Exercise Images",
		},
		{
			...
			Src:   "/public/images/previews/maxes.png",
			Alt:   "Exercises Maxes",
		},
		{
			Title: "Cloud Backups",
			...
			Src:   "/public/images/previews/backup.png",
			Alt:   "Cloud Backups",
		},
		{
			...
			Src:   "/public/images/previews/tag-exercise.png",
			Alt:   "Exercise Tags",
		},
		{
			...
			Src:   "/public/images/previews/tags.png",
		...
		},
		{
			...
			Src:   "/public/images/previews/w-snapshots.png",
